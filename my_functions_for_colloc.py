...
def function_N13(num1: NaturalNumber, num2: NaturalNumber):
...
def function_N14(num1: NaturalNumber, num2: NaturalNumber):
    return MOD_NN_N(num1 * num2, function_N13(num1, num2)) # нужна функция умножения чисел
...
def function_Q5 (frac1: RationalNumber, frac2: RationalNumber):
    denominator = (function_N14(frac1.denominator,frac2.denominator))
...
def function_Q6(frac1: RationalNumber, frac2: RationalNumber):
    denominator = (function_N14(frac1.denominator, frac2.denominator))
    numerator = frac1.numerator * (MOD_NN_N(denominator, frac1.denominator)) - frac2.numerator * (MOD_NN_N(denominator, frac2.denominator))
    frac_sum = RationalNumber(numerator, denominator)
    return(frac_sum)
